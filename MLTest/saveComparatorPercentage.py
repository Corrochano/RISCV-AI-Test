...
def compare_profiles(file1, file2):
    ...
    with open(output_file, "w") as out:
        ...
        out.write(f"{'Operation'.ljust(45)} File1(s) File2(s) Improve(%)\n")
        out.write("-" * 75 + "\n")
        ...
        for op in common:
            ...
            if t1 > 0:
                ...
                improvement = 0.0  # avoid division by zero

            out.write(f"{op.ljust(45)} {t1:10.6f} {t2:10.6f} {improvement:10.2f}\n")
